	...
	ScrollScene.prototype.addIndicators = function(options) {
		...
		if (controller) {
			var
				...
				$wrap = $("<div style='width:0px;overflow:hidden;'></div>")
				...
				$triggerHook = $("<div style='width:0px;overflow:hidden;'>trigger</div>")
								.css({
									position: "fixed",
									overflow: "visible",
								...
								.addClass("hook");
				$start = $("<div style='width:0px;overflow:hidden;'>start" + suffix + "</div>")
								.css({
									position: "absolute",
									overflow: "visible",
								...
								.addClass("start");
				$end = $("<div style='width:0px;overflow:hidden;'>end" + suffix + "</div>")
								.css({
									position: "absolute",
									overflow: "visible",
